...
| --- | --- | --- | --- |
| `1703659196` | 接受早期 `FASTBOOT`，回 `TOOBTSAF`，设置 mode 99 | 保留 `flash:`、`erase:` | 完整基线 |
| `1723478295` | 与旧版相同 | 与旧版相同 | 小幅重编译，功能面稳定 |
| `19` | 与旧版相同 | 与旧版相同 | V241216 基线 |
...
| `preloader_raw_b-v260629.img` | 4,190,208 | `76e76d566b48d21387daabc7cbd2e972782995cebd4c07cd01cc5e3e823636f4` | V260629，早期 Fastboot 请求入口受限 |
| `lk_b-v260629.img` | 8,388,608 | `4b5f932dee1d3d6f42a23a4f25c058fae7c7c14488b44d5df0959c6c7252f80e` | V260629，标准 Fastboot 写入/擦除入口受限 |
